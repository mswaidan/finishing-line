...
def test_flash_accumulates_only_while_the_fan_is_on(cfg):
    ...
    parts = advance_flash_timers(state, dt=10.0)
    ...
    parts = advance_flash_timers(paused, dt=10.0)
...
def test_part_away_from_a_fan_banks_nothing(cfg):
    ...
    parts = advance_flash_timers(state, dt=60.0)
...
def test_timer_targets_the_active_coat(cfg):
    ...
    parts = advance_flash_timers(state, dt=180.0)
    ...
    parts = advance_flash_timers(after_coat_2, dt=180.0)
    assert parts["p1"].flash_1_s == 180.0
